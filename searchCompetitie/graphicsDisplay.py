...
GHOST_SIZE = 0.65
SCARED_COLOR = formatColor(1,0,1)

GHOST_VEC_COLORS = map(colorToVector, GHOST_COLORS)

PACMAN_COLOR = formatColor(255.0/255.0,255.0/255.0,61.0/255)
PACMAN_COLOR1 = formatColor(100.0/255.0,255.0/255.0,61.0/255)
PACMAN_COLOR2 = formatColor(255.0/255.0,100.0/255.0,61.0/255)
PACMAN_COLOR3=formatColor(255.0/255.0,255.0/255.0,255.0/255)
PACMAN_COLOR4=formatColor(0.0/255.0,0.0/255.0,0.0/255)
PACMAN_SCALE = 1
#pacman_speed = 0.25
...
class InfoPane:
    ...
    def drawPane(self):
        ...
        self.scoreText1 = text( self.toScreen(200, 0), self.textColor1, "SCORE: 0", "Times", self.fontSize, "bold")
...
class PacmanGraphics:
    ...
    def swapImages(self, agentIndex, newState):
        ...
        if newState.isPacman==1 or newState.isPacman==0:
    ...
    def update(self, newState):
        ...
        prevState, prevImage = self.agentImages[agentIndex]
        if agentState.isPacman==1 or agentState.isPacman==0:
        ...
        self.infoPane.updateScore(agentIndex,newState.score)
    ...
    def drawPacman(self, pacman, index):
        ...
        if index==1:
            outlineColor = PACMAN_COLOR1
            fillColor = PACMAN_COLOR1
        if index==2:
        ...
        return [circle(screen_point, PACMAN_SCALE * self.gridSize,
                       ...
                       fillColor = eyes2, outlineColor = eyes2,
                       endpoints = endpoints,width=width),circle2(screen_point, PACMAN_SCALE * 0.2* self.gridSize,
                       fillColor = eyes, outlineColor = eyes,
    ...
    def movePacman(self, position, direction, image):
        ...
        moveCircle2(image[1], screenPosition, r)
        moveCircle2(image[2], screenPosition, r)
        refresh()
...
class FirstPersonPacmanGraphics(PacmanGraphics):
    ...
    def getPosition(self, ghostState):
        if not self.showGhosts and ghostState.isPacman>1 and ghostState.getPosition()[1] > 1:
            return (-1000, -1000)
        else:
